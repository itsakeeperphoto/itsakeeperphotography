...
- Conversion action: none in the hero; its local control only scrolls to the confirmation. The sole body anchor opens `/portfolio/` from the photographic close.
...
| Close | Full-bleed couple landscape, shallow umber wash, one outlined Portfolio anchor centered beneath the copy | Existing raster photography plus semantic anchor |
